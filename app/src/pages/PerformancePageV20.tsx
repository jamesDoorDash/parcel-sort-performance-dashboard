      ...
      {card.delta && (
        isNeutral ? (
          ...
          <span className={cn("flex items-baseline gap-1", deltaTone)}>
            ...
            <span className={cn("text-[0.8125rem] leading-[1.2] font-normal", card.delta.tone === "negative" ? "text-negative" : "text-ink-subdued")}>vs. target</span>
          </span>
        )
      )}
    </div>
...
export function PerformancePageV20() {
