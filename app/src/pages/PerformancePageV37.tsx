...
import { AssociatesInsightsV2 } from "../components/AssociatesInsightsV2";
...
export function PerformancePageV37() {
        ...
        <section className="mt-8">
          ...
          {row1Expanded === "associates" && (
            <div className="overflow-hidden rounded-[12px] border border-line-hovered bg-white pt-5">
              <h3 className="px-4 pb-4 text-[16px] leading-[22px] font-bold tracking-[-0.01em] text-ink">Related metrics</h3>
              <AssociatesInsightsV2 sorters={sorters} />
