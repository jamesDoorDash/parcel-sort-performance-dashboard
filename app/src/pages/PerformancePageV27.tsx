  ...
  return (
    <section>
      <div className="flex items-center justify-between px-1 pb-2">
        <h2 className="text-[18px] leading-[24px] font-bold tracking-[-0.01em] text-ink">{title}</h2>
        {chart && (
          <button type="button" onClick={onToggle} className="text-body-md text-ink underline">
...
export function PerformancePageV27() {
