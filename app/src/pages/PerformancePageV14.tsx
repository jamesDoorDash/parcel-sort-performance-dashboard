...
import { ChevronDown, Info, RefreshCw, AlertTriangle } from "lucide-react";
...
function SectionKpiCard({ card }: { card: V3MetricCard }) {
  ...
  return (
    <div className="flex min-w-0 flex-col items-start gap-1 rounded-[12px] border border-[#e7e7e7] bg-white px-6 py-4">
      {/* Title + Tag */}
...
export function PerformancePageV14() {
