...
function SectionKpiCard({ card }: { card: V3MetricCard }) {
  ...
  const tintBg = isPlaceholder || !card.delta ? "" : isGood ? "bg-[#f0faf0]" : "bg-[#fff0ed]";

  return (
    <div className={cn("flex flex-col items-start gap-1 rounded-[8px] px-3 py-2", tintBg)}>
      {/* Title */}
      <div
        className="relative"
...
export function PerformancePageV18() {
