...
function SectionKpiCard({ card }: { card: V3MetricCard }) {
  ...
  return (
    <div className={cn("flex flex-col items-start rounded-lg py-3 px-3 -mx-3", isOffTarget && "border-l-[3px] border-l-negative bg-white")}>
      <div
        className="relative"
...
export function PerformancePageV8() {
