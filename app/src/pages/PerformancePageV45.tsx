...
export function PerformancePageV45() {
      ...
      <div className="mx-auto w-full max-w-[1220px] px-12 pt-12 pb-16">
        ...
        <section className="mt-3">
          <div className="flex items-baseline justify-between pb-2.5">
            <h2 className="text-[24px] leading-[32px] font-bold tracking-[-0.01em] text-ink">Top level metrics</h2>
            <span className="inline-flex items-baseline gap-[10px]">
              ...
              >
                <span className="metric-label-underline text-[16px] leading-[22px] font-bold tracking-[-0.01em] text-ink">Overall grade</span>
                {gradeTooltipOpen && (
        ...
        <section className="mt-10">
          <h2 className="pb-4 text-[24px] leading-[32px] font-bold tracking-[-0.01em] text-ink">Flow rates</h2>
          <div className="grid grid-cols-3 gap-4">
