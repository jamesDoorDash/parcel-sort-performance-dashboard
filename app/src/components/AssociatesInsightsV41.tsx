...
export function AssociatesInsightsV41({ sorters, loadRateLabel = "Load rate", onNameClick, coachingSectionLabel = "Most in need of coaching", coachingSectionTooltip = "The 3 most underperforming associates based on a combination of sort rates, load rates, missloads, missorts, lost items, idle time, and other quality metrics." }: Props) {
