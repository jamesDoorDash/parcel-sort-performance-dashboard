...
const thisWeekSimpleSeries: Record<Exclude<V3MetricId, "parcelsProcessed" | "parcelDwellTime">, V3SimpleSeriesDay[]> = {
  parcelsSortedOnTime: [
    ...
    day("2026-02-10", "Feb 10", 97.6),
    day("2026-02-11", "Feb 11", 99.0),
    day("2026-02-12", "Feb 12", 96.0),
    day("2026-02-13", "Feb 13", 98.0),
  ...
  parcelsReturnedOnTime: [
    day("2026-02-09", "Feb 9", 98.0),
    day("2026-02-10", "Feb 10", 97.5),
    day("2026-02-11", "Feb 11", 99.0),
    day("2026-02-12", "Feb 12", 96.5),
    day("2026-02-13", "Feb 13", 98.0),
  ...
  trucksDepartedOnTime: [
    ...
    day("2026-02-10", "Feb 10", 98.8),
    day("2026-02-11", "Feb 11", 99.3),
    day("2026-02-12", "Feb 12", 98.4),
    day("2026-02-13", "Feb 13", 99.2),
